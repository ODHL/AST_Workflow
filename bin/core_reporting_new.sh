# bash bin/core_reporting_new.sh /home/ubuntu/output/testing_basic basic
...
if [[ -d $process_dir_files ]]; then rm $process_dir_files/*; else mkdir $process_dir_files; fi
process_dir_out="/home/ubuntu/tools/ar_report_generator/processing_output"
if [[ -d $process_dir_out ]]; then rm $process_dir_out/*; else mkdir $process_dir_out; fi
...
for output_dir in ${project_list[@]}; do
